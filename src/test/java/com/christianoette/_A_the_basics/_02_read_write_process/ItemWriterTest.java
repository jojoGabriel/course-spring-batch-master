...
class ItemWriterTest {
    ...
    static class TestConfig {
        ...
        public Step readerStep() {
        	...
        	SimpleStepBuilder<InputAndOutput, InputAndOutput> simpleStepBuilder = 
        			stepBuilderFactory.get("readJsonStep").chunk(1);
...
//        } 
        ...
        @Bean
        public JsonItemReader<InputAndOutput> reader() {
            File file;
            try {
            ...
            return new JsonItemReaderBuilder<InputAndOutput>()
                    .jsonObjectReader(new JacksonJsonObjectReader<>(InputAndOutput.class))
        ...
        @Bean
        public JsonFileItemWriter<InputAndOutput> writer() {
        	
        	Resource outputResource = new FileSystemResource("output/output.json");
        	
        	return new JsonFileItemWriterBuilder<InputAndOutput>()
